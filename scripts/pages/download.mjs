...
<section class="section"><div class="section__in">
  <div class="sectionhead"><h2>Up and running.</h2><span class="cap">Installation</span></div>
    <div data-install="macos"><ol class="install-steps"><li>Unzip the complete download.</li><li>Move <strong>nus.app</strong> into Applications.</li><li>Head to <b>System Settings</b> › <b>Privacy & Security</b> › <b>"nus" was blocked...</b> › click <b>Open Anyway.</b></li><li>Open <i>nus</i> and choose your shell. Your existing shell configuration comes with you.</li></ol><p class="dim small">Check the package record above for the exact signing and notarization status.<br>Preview builds are currently unsigned as of Sep 21 2026<br><i>(dev note: i hope to sign packages by next week pending sponsors).</i></p></div>
