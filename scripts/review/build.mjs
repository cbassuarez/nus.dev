...
function releasesPage(entry,record) {
  ...
  <div class="review-actions"><button class="btn btn--quiet" data-check-releases="${e(release?.tag_name||REVIEW.releaseTag)}" type="button">Check for newer releases</button><a href="${SITE.repo}/releases">All releases ↗</a></div><p class="small dim" data-release-check-status role="status" aria-live="polite">The static snapshot is available without JavaScript.</p>
